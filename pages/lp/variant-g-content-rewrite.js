  ...
  >
    ...
    <div className="relative container mx-auto px-6 py-24 text-center w-full">
      <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight leading-tight">
        ...
        <span className="block mt-2 text-orange-400">Organize Your Case Evidence.</span>
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (firebaseReady) {
                ...
                await subscribeLeadFn({ email, name: '', origin: "threadlock.ai/lp/variant-g-content-rewrite" });
            } else {
...
/* ---------------- Main Page ---------------- */
export default function VariantGContentRewrite() {
