    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (firebaseReady) {
                ...
                await subscribeLeadFn({ email, name: '', origin: "threadlock.ai/lp/variant-d-copy-organize" });
            } else {
...
/* ---------------- Main Page ---------------- */
export default function VariantDCopyOrganize() {
    const [isPromoModalOpen, setIsPromoModalOpen] = useState(false);

    return (
        <div className="bg-white">
            <LandingPageHead 
                title="ThreadLock™ | Organize Your Case Now"
