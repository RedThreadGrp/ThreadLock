    ...
    <div className="w-full h-full bg-slate-800 rounded-xl p-3 md:p-4 flex flex-col md:flex-row gap-3 text-white">
        ...
        <div className="w-full md:w-2/3 bg-slate-700/50 rounded-lg p-3 flex flex-col">
            ...
            <div className="flex justify-end gap-2 mt-2">
                ...
                <button className="text-[11px] bg-[#004a99] px-3 py-1 rounded">Save Entry</button>
            </div>
        </div>
    </div>
);
        ...
        <div className="relative flex-grow pl-6 pr-3">
            ...
            <div className="space-y-3">
                <div className="relative">
                    <div className="absolute -left-5 top-1 w-2 h-2 bg-[#004a99] rounded-full"></div>
...
const PdfExportUIMockup = () => (
    <div className="w-full h-full bg-slate-800 rounded-xl p-4 flex flex-col items-center justify-center text-white">
        ...
        <button className="text-[11px] bg-[#004a99] text-white px-4 py-1.5 rounded-md mt-3">Download PDF</button>
    </div>
);
        ...
        <header className={`fixed top-0 left-0 w-full z-30 transition-all duration-300 ${headerClasses}`}>
            <div className="container mx-auto px-4 md:px-6 py-3 flex items-center justify-between">
                ...
                <nav className={`hidden md:flex items-center space-x-6 font-semibold ${navTextClasses}`}>
                    ...
                    <button
                        onClick={onCTAClick}
                        className="bg-[#004a99] text-white font-bold px-5 py-2 rounded-lg shadow-md hover:bg-[#003d80] transform hover:-translate-y-0.5 transition-all"
                    >
                        Sign Up
                    </button>
                </nav>
            ...
            <div className={`md:hidden overflow-hidden transition-[max-height] duration-300 ${open ? "max-h-96" : "max-h-0"}`}>
                <div className="px-4 pb-4 pt-2 space-y-2 bg-white border-t border-slate-200">
                    ...
                    <button
                        ...
                        className="w-full mt-2 bg-[#004a99] text-white font-semibold px-5 py-3 rounded-lg shadow-md hover:bg-[#003d80] transition-all block text-center"
                    >
                        Sign Up
                    </button>
                </div>
  ...
  >
    <div className="relative container mx-auto px-6 py-24 text-center w-full">
      <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight leading-tight">
        ...
        <span className="block mt-2 text-blue-700">Organized.</span>
      ...
      <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center">
        <button
          onClick={onCTAClick}
          className="bg-[#004a99] text-white font-bold px-8 py-4 rounded-lg shadow-lg hover:bg-[#003d80] transform hover:-translate-y-1 transition-all duration-300 ease-in-out text-center"
        >
    ...
    <div className="container mx-auto px-6">
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-center">
          <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-blue-100 to-blue-200 text-[#004a99] flex items-center justify-center rounded-xl">
...
const SubscriptionBanner = ({ onCTAClick }) => (
  ...
  >
    <div className="container mx-auto px-6 text-center relative">
      <div className="inline-block px-6 py-5 mb-10 border-2 border-[#004a99] rounded-xl bg-white/80 backdrop-blur-sm shadow-md">
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <div className="bg-white/90 backdrop-blur-md p-8 rounded-2xl border-2 border-slate-200 hover:border-[#004a99] transition-all shadow-lg text-left flex flex-col">
          <div className="mb-6">
          ...
          <button
            onClick={onCTAClick}
            className="mt-8 block text-center bg-[#004a99] text-white font-bold px-6 py-3 rounded-lg shadow-md hover:bg-[#003d80] transition-all"
          >
            Get Started
          </button>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl border-2 border-[#004a99] p-8 shadow-xl flex flex-col relative">
          <div className="absolute top-0 right-0 bg-[#004a99] text-white text-xs font-bold px-4 py-1 rounded-bl-lg rounded-tr-xl">
            POPULAR
          </div>
          <div className="mb-6">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span className="text-slate-800">
                  Upload & Assign Your Firm&apos;s Custom Forms <span className="bg-[#004a99] text-white text-xs px-2 py-0.5 rounded-full ml-1">New</span>
                </span>
              </li>
              <li className="flex items-center">
                <CheckmarkIcon color="green-600" />
...
const FeatureCard = ({ icon, title, children }) => (
    <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 flex items-start gap-6 text-left">
        <div className="w-16 h-16 shrink-0 bg-gradient-to-br from-blue-100 to-blue-200 text-[#004a99] flex items-center justify-center rounded-xl">
            {icon}
        </div>
        <div>
                            ...
                            <div className="flex gap-2">
                                {slides.map((_, i) => (
                                    <div
                                        key={i}
                                        onClick={() => setIdx(i)}
                                        className={`h-3 w-3 rounded-full cursor-pointer transition-colors ${idx === i ? "bg-[#004a99]" : "bg-slate-300 hover:bg-slate-400"}`}
                                    />
                                ))}
                            </div>
...
const OurMissionSection = () => (
  ...
  >
    ...
    <div className="relative container mx-auto px-6 text-center max-w-4xl">
      ...
      <div className="border-l-4 border-[#004a99] pl-6 md:pl-8 text-left">
            ...
            <div className="container mx-auto px-6 text-center max-w-3xl">
                ...
                <form onSubmit={handleSubmit} className="max-w-md mx-auto">
                    <div className="flex flex-col sm:flex-row gap-4">
                        ...
                        <button 
                            type="submit" 
                            className="bg-[#004a99] text-white font-bold px-6 py-3 rounded-lg shadow-md hover:bg-[#003d80] transition-all disabled:bg-slate-400"
...
/* ---------------- Main Page ---------------- */
export default function VariantBLightBlue() {
    const [isPromoModalOpen, setIsPromoModalOpen] = useState(false);

    return (
        <div className="bg-slate-50">
            <LandingPageHead 
                title="ThreadLock™ | Start Your Free Trial"
            ...
            <style jsx global>{`
                ...
                /* Light theme overrides with blue CTA */
                .btn-primary {
