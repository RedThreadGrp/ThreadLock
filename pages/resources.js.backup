...
/* Find Your Court Rules section */
const FindCourtRulesSection = () => {
  return (
    <section id="find-court-rules" className="py-16 md:py-20 bg-white relative z-10">
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="flex items-center gap-4 mb-3 justify-center">
          <div className="w-12 h-12 bg-green-100 text-green-600 flex items-center justify-center rounded-lg">
            <GlobeIcon className="w-6 h-6" />
          </div>
          <h2 className="text-2xl md:text-3xl font-bold text-slate-900">Find Your Court Rules</h2>
        </div>
        <p className="text-base md:text-lg text-slate-600 mb-8 text-center">
          Use this official directory to find your state court website and rules.
        </p>
    ...
    <>
      ...
      <div className="bg-gray-50">
        ...
        <main className="flex flex-col w-full overflow-x-hidden">
          ...
          {/* Find Your Court Rules - First content block */}
          <FindCourtRulesSection />

          {/* Browse by Topic Section - Second */}
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {topicsData.map((topic) => (
                  <Link
                    ...
                    className="bg-white p-6 rounded-xl border border-slate-200 hover:border-orange-500 hover:shadow-lg transition-all"
                  >
