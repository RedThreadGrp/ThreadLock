...
export default function AuIndex({ hubs, rootMeta }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-foreground-dark mb-2">All States &amp; Territories</h2>
        <p className="text-muted-dark text-sm">Select your state or territory to see available court guides.</p>
      </div>
