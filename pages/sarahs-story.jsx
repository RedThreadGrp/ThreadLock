    ...
    <>
      <style jsx global>{`
        ...
        :root{
          ...
          /* images from /public */
          --hero-url: url('https://i.imgur.com/uBl9s8s.jpeg');      /* woman (hero) */
          --quote-url: url('https://i.imgur.com/v1K5u5V.jpeg');     /* man + child (behind quote) */
          --result-url: url('https://i.imgur.com/b5g3m2e.jpeg');    /* forest (result section) */
        }
