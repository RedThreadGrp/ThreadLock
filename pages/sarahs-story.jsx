        ...
        <>
            ...
            <style jsx global>{`
                ...
                .hamburger-button {
                    ...
                    border: none;
                    cursor: pointer;
                    z-index: 60; /* Ensure it's above other header content */
                }
                @media (min-width: 768px) {
                    .hamburger-button {
                ...
                .hero {
                    ...
                    text-align: center;
                    background-color: var(--white);
                    background-image: url('https://i.imgur.com/k9b6M2p.png'); /* Hero background image */
                ...
                .story-step.highlighted.left-oriented {
                    background-image: url('https://i.imgur.com/gK96v74.png'); /* New background image */
                ...
                @media (max-width: 767px) {
                    ...
                    .story-step.left-oriented,
                    .story-step.right-oriented {
                        text-align: center; /* Center align all story steps on mobile */
                    }

                    .story-blockquote {
                        text-align: left; /* Keep blockquotes readable */
                    }
                }
            `}</style>
