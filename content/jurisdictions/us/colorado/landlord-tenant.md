---
jurisdiction_slug: colorado
jurisdiction_name: Colorado
practice_area: landlord-tenant
country: us
province_or_state: state

title: "Landlord-Tenant Law in Colorado — Eviction, Deposits & Tenant Rights"
meta_description: "Colorado landlord-tenant law: 10 days demand for compliance eviction notice, deposit returned 30 days after move-out. Filing guide for landlords and ten..."

court_name: "Colorado County Court (Forcible Entry and Detainer)"
notice_to_quit: "10 days demand for compliance; 3 days for substantial lease violations"
security_deposit_deadline: "30 days after move-out (60 days if itemized deductions provided)"
filing_fee: "$100–$200"
hearing_timeline: "7–14 days after filing"
court_url: "https://www.courts.state.co.us/userfiles/file/Self_Help/LandlordTenant/"
statute_citation: "CRS §38-12-101 (Landlord-Tenant); CRS §13-40-101 (Unlawful Detainer)"
...
<!-- SECTION: faq -->
Q: How much notice does a landlord need to give before evicting a tenant in Colorado?
A: The required notice depends on the reason. For nonpayment of rent: 10 days demand for compliance; 3 days for substantial lease violations. A landlord who files without giving proper notice first may have the case dismissed. The notice must be properly served — not just sent — and the full notice period must expire before filing.

Q: How long does a landlord have to return a security deposit in Colorado?
A: 30 days after move-out (60 days if itemized deductions provided). If the landlord misses this deadline or fails to provide an itemized statement of deductions, they may lose the right to withhold any portion of the deposit. Security deposits in Colorado are capped at 2 months' rent.
...
A: Tenants in Colorado have the right to a habitable rental unit. If a landlord fails to make repairs after being notified in writing, a tenant may be able to file a complaint with the Colorado County Court (Forcible Entry and Detainer), withhold rent (in some jurisdictions), or pursue other remedies under Colorado law. Document every repair request in writing with the date sent — this record is essential if the matter goes to court.
