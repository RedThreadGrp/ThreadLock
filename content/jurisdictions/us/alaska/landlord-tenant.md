...
title: "Landlord-Tenant Law in Alaska — Eviction, Deposits & Tenant Rights"
meta_description: "Alaska landlord-tenant law: 7 days for nonpayment eviction notice, deposit returned 14 days after move-out. Filing guide for landlords and tenants."

court_name: "Alaska District Court"
notice_to_quit: "7 days for nonpayment; 10 days for lease violations"
security_deposit_deadline: "14 days after move-out (no deductions); 30 days (with itemized deductions)"
filing_fee: "$100–$200"
hearing_timeline: "7–21 days after filing"
court_url: "https://courts.alaska.gov/shc/housing/index.htm"
statute_citation: "AS 34.03 (Alaska Uniform Residential Landlord and Tenant Act)"
...
<!-- SECTION: faq -->
Q: How much notice does a landlord need to give before evicting a tenant in Alaska?
A: The required notice depends on the reason. For nonpayment of rent: 7 days for nonpayment; 10 days for lease violations. A landlord who files without giving proper notice first may have the case dismissed. The notice must be properly served — not just sent — and the full notice period must expire before filing.

Q: How long does a landlord have to return a security deposit in Alaska?
A: 14 days after move-out (no deductions); 30 days (with itemized deductions). If the landlord misses this deadline or fails to provide an itemized statement of deductions, they may lose the right to withhold any portion of the deposit. Security deposits in Alaska are capped at 2 months' rent.
...
A: Tenants in Alaska have the right to a habitable rental unit. If a landlord fails to make repairs after being notified in writing, a tenant may be able to file a complaint with the Alaska District Court, withhold rent (in some jurisdictions), or pursue other remedies under Alaska law. Document every repair request in writing with the date sent — this record is essential if the matter goes to court.
